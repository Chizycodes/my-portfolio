...
export const Intro = () => {
	return (
		...
		>
			...
			<h2 className="text-4xl text-textDark md:text-6xl">I build amazing websites!</h2>
			...
			<div className="flex space-x-3">
				...
				<Link activeClass="active" duration={500} href="contact" offset={-100} smooth={true} spy={true} to="work">
