	...
	return (
		...
		>
			<a
				...
				target="_blank"
				className={`w-full relative rounded-xl border-neon border p-2 transition hover:-translate-y-2 hover:opacity-75 hover:border-fun-pink will-change-projectCard`}
			>
